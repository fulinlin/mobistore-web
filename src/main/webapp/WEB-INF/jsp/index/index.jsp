	...
	<div id="main">
	      ...
	      <div class="navbar-inner">
	         ...
	         <div class="nav-collapse">
	           ...
	           <ul class="nav pull-right">
			  	 <li class="dropdown">
				    <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, ${sessionScope.session_loginfo.user.email}</a>
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				<div id="left">
					<iframe id="menuFrame" name="menuFrame" src="${ctx}/menu/menu" style="overflow:visible;"
			...
			Copyright &copy; 2015-${fns:getDate('yyyy')} 江苏喔来科技有限公司 ${fns:getConfig('productName')} 
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
