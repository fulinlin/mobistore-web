...
public final class Constant {
	...
	public static final  String alipay_notify_url = WEB_PATH + "api/mobi/payment/alipay/callback";
	...
	public static final  String unionpay_notify_url_consume = WEB_PATH + "api/mobi/payment/unionpay/consume/callback";
	public static final  String unionpay_notify_url_delegate = WEB_PATH + "api/mobi/payment/unionpay/delegate/callback";
	...
	public static final  String wechat_pay_notify_url = WEB_PATH + "api/mobi/payment/wechat/callback";
