...
public final class Constant {
	...
	public static final  String alipay_notify_url = WEB_CLIENT_URL + "/wolai-web/api/mobi/payment/alipay/callback";
	...
	public static final  String wechat_pay_notify_url = WEB_CLIENT_URL + "/wolai-web/api/mobi/payment/wechat/callback";
