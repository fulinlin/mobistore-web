...
import com.tinypace.mobistore.service.PaymentWechatHttpsRequest;
import com.tinypace.mobistore.service.impl.PaymentWechatServiceImpl;
import com.tinypace.mobistore.wechat.WechatConfigure;
...
@Service
public class PaymentWechatHttpsRequestImpl implements PaymentWechatHttpsRequest{
	private static Log log = LogFactory.getLog(PaymentWechatHttpsRequestImpl.class);
    ...
    public PaymentWechatHttpsRequestImpl() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        init();
    }
